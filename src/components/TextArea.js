    ...
    return (
        <>
            <div className="container my-3" >
                <label htmlFor="exampleFormControlTextarea1" style={{color: props.mode === 'dark'? 'white' : 'black'}}><b> {props.heading} </b></label>
                <div className="mb-3 my-3">
                    ...
                    <div>
                        <button className={`btn btn-outline-${props.btnColor} my-3`} onClick={copyText}> <i> Copy text </i> </button>
                    </div>
                    <button className={`btn btn-outline-${props.btnColor} my-3`} onClick={upperClickFunc}> To Uppercase</button>
                    <button className={`btn btn-outline-${props.btnColor} mx-1 my-3`} onClick={lowerClickFunc}> To Lowercase</button>
